...
### Default Time Range: FY26 YTD (Year-to-Date)

**When you ask questions WITHOUT specifying a time period**, the agent defaults to:
- **FY26 YTD**: From February 1, 2025 to today's date

**Examples**:
```
"What is the average daily cost?"
→ Returns data from Feb 1, 2025 to today (FY26 YTD)
...
### How to Query Different Time Ranges

**FY26 YTD** (default - no time specified):
```
"What is the average daily cost?"
"Top 10 application spends"
```

**Entire Fiscal Year** (explicitly mention "entire" or "full"):
```
...
**Past Fiscal Years**:
```
"What was the total cost for FY25?"
"Compare FY25 vs FY26 spending"
```

**Specific Dates/Months**:
```
"What is cost for February 2025?"
...
```
"What is the total cost for FY26?"                    → FY26 YTD (Feb 1, 2025 to today)
"What are the top 3 most expensive applications?"     → FY26 YTD
"Show me GenAI costs by cloud provider"               → FY26 YTD
"Which managed services cost the most in production?" → FY26 YTD
"Compare FY25 vs FY26 spending"                       → Full FY25 vs FY26 YTD
"What is total cost for entire fiscal year FY26?"    → Full FY26 (Feb 1, 2025 - Jan 31, 2026)
```
